file:///Users/miabundgaard/Desktop/GlobalDevelopment-main/GlobalDevelopment.html
---
...
## Using scale_x_log10() makes sense because GDP per capita varies hugely across countries

2. *Answer: In Figure 1: Who is the outlier (the richest country in 1952) far right on the x axis?* 

## I use the code below to find out the richest country in 1952, which is Kuwait
...
## I use the same code as before, but write 2007 instead and head(5) to figure out the 5 richest countries in 2007, which is Norway, Kuwait, Singapore, The United States and Ireland
